...
private:
    ...
    void update_leg_states_(const JointFeedbackFrame& joint_feedback, double entry_angle,
    ...
    void update_leg_suspension_state_(size_t index, const LegFeedback& leg_feedback,
        bool requested_deploy, double entry_angle, double release_angle, double dt) {
        auto& leg_state = leg_control_states_[index];
